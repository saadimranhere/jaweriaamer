...
const selectClass =
  "w-full rounded-xl border border-border/80 bg-white px-3 py-2.5 text-sm text-navy shadow-sm focus-visible:border-ring focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/35";
    ...
    <section className="bg-cream py-12 sm:py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
          ...
          >
            <p className="font-serif text-sm font-semibold text-navy">All</p>
            ...
            return (
              ...
              >
                <div className="mb-2 flex items-center gap-2">
                  ...
                  <span className="font-serif text-sm font-semibold text-navy">{cat.label}</span>
                </div>
        ...
        >
          <div className="mb-3 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h2 className="font-serif text-lg font-semibold text-navy">Filters</h2>
            </div>
            <button
              type="button"
